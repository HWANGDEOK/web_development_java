...
public class RemoteController {
    ...
    public RemoteController(PowerButton powerButton, ChannelUpButton channelUpButton, ChannelDownButton channelDownButton, VolumeDownButton volumeDownButton, VolumeUpButton volumeUpButton) {
        ...
        // 마찬가지로 이걸 완성하는 순간 Main 단계에서 오류가 발생함 -> 아까전에는 Main이 AllArgs를 만족했으니 이젠 아니기 때문
    }
    ...
    // ChannelDownButton의 메서드 구현 -> 메서드 두 개씩입니다.
