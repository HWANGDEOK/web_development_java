...
/*
    ...
    예시
    random.nextInt() 와 Scanner.nextInt()에서도 본 적이 있다.
 */
...
//        System.out.println(Arrays.toString(arr2));
        ...
        System.out.println("오름차순 정렬 배열 : " +Arrays.toString(arr3));

        // 내림차순 배열
        Arrays.sort(arr3, Comparator.reverseOrder());   // 마찬가지로 재대입하지 않아도 이미 내림차순 정리가 됨.
        // Comparator.reverseOrder() 메서드를 적용하기 위해서는 <T>가 요규되고, T는 클래스여야만하기 때문에
        // int 라는 원시 자료형은 해당되지 않음 -> 이 문제를 해결하기 위해 Integer 클래스 도입
        System.out.println("내림차순 정렬 배열 : " +Arrays.toString(arr3));
