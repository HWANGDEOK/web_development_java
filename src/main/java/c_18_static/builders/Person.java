...
//        private String name;
         private final String name;       //-> final 적용했을 때와 아닐 때의 예시를 둘 다 표시해두었습니다.
        private int age;
        private String address;
...
//        }
        ...
        // 최종 객체 생성 메서드
        public Person build() {
            return new Person(this);        // 이 단계까지 왔을 때 Person의 객체가 생성됩니다.
    ...
    // 여기까지 작성이 끝나셨으면 PersonMain.java로 가시면 됩니다.

    // 빌더 패턴말고 기존의 방식대로 생성자를 정의하는 내용입니다.
    // 이 이하의 코드가 불편해서 빌더 패턴이 나왔다고 보면됨.
