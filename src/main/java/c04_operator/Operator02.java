...
public class Operator02 {
    public static void main(String[] args) {
        /*
            ---------------논리 연산자---------------
           true(10, false(0) : 컴퓨터가 읽을 수 있는 두 가지
           boolean : true / false를 구분하는 자료형

           AND(&&) -> 곰 T x T = T // T x F = F // F x F = F => 하나라도 false라면 false
           OR(||) -> 합 T + T = T // T + F = T // F + F = T = 하나라도 true라면 true
        ...
        boolean flag2 = false;
//
//        boolean result1 = flag1 && flag2;   // AND 연산자 활용 : 곱연산
...
//        System.out.println("F + F = " + result6);
        ...
        System.out.print("안녕하세요.\t");   // \t -> 2칸 혹은 4칸 띄어쓰기
        System.out.print("\n안근수입니다.");     // \n -> 개행(enter키)
        ...
        boolean result9 = 10 % 3 == 0;  // '10 % 3의 결과값이 0이 아니면' 이라는 의미
