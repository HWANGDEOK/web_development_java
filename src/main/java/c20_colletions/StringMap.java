...
/*
    Map
        특징 :
            ...
            - 키는 중복을 허용하지 않으면, 값은 중복이 가능합니다. -> JSON이라는 형태와 가장 유사하기 때문

        구현체 :
            1) HashMap - 순서를 유지하지 않습니다.
            2) LinkedHashMap - 입력할 순서를 유지합니다.
...
public class StringMap {
    public static void main(String[] args) {
        ...
        // Map의 엔트리(Key - Value 동시에 지징하는 개념)로부터 list 생성 과정
