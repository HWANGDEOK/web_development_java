package c20_colletions;

import java.util.*;

/*
    1. Java Collection Framework 란?
        자바에서 데이터를 효율적으로 저장하고 관리하기 위한 자료구조와 알고리즘을 제공하는 라이브러리
        컬렉션 프레임워크를 사용하면 다양한 자료구조를 쉽게 구현하고, 데이터를 추가, 삭제, 정렬, 검색 등의 작업을
        간편하게 수행 가능.
...
public class StringList {
    public static void main(String[] args) {
        ...
        // 특정 문자열 검색
        // 이 부분에서 쓸거라 여기에 Scanner import 하겠습니다
...
//        System.out.println("검색할 요소를 입력하세요 : ");
        ...
        // 특정 문자열 삭제
        String removeStr = "C#";
        boolean removed = strList.remove(removeStr);    // .remove() 삭제하는 메서드
        ...
        // py 문자열이 삭제돼서 thon만 남는다거나 하는 일은 없습니다.

        // List의 특정 인덱스 요소 조회
        System.out.println(strList.get(1));     // .get(인덱스넘버)를 통해 조회 가능

        // List 정렬
        Collections.sort(strList);   // 여기서 이미 정렬이 완료됨 -> 재대입할 필요 없
