...
// 접근 지정자가 명시되어있지 않습니다. -> 그리고 이런 방식으로 시험문제가 나오는 편입니다.
class Shape{
    public void draw(){
...
public class WildcardExample02 {
    ...
    public static void main(String[] args) {
        // 이하의 형태도 argument Circle의 객체를 생성해서 넣은 케이스입니다.
        ...
        // List<? extends Shape> 는 Shape 클래스의 객체와, 그 하위 클래스(Circle, Rectangle)의 객체만 받을 수 있음.
        // shapes 리스트에서 요소를 읽는 것은 안전하지만, 새로운 요소를 추가하려고 하면 컴파일 오류가 발생할 수 있습니다.
        // 다 하셨으면 WildcardExample03.java 생성해주세요
    }
}
