...
/*
    JSON(JavaScript Object Notation) : 본재 자바스크립트 언어로부터 파생되어 자바스크립트 구문을 따르지만,
        언어독립형 포멧.
...

    {
        ...
        "이스케이프": "키가 값에서 큰따옴표를 쓰고 싶으면-특정 문자를 이스케이프 하려면- \" 처럼 문자 앞에 역슬래시
        "자료형": "표현 가능한 자료형은 String, int, double, boolean, null, object, array 6개
...
public class JSON01 {
    public static void main(String[] args) {
        // JsonObject를 생성하고 속성(키-값 쌍)을 추가(addProperty() 메서드 사용)
