...
public class JSON02 {
    public static void main(String[] args) {
        ...
        // gson gsonBuilder를 통해 해당 JSON 파일을 콘솔창에 띄워보세요.

        JsonObject jsonObject = new JsonObject();
        jsonObject.addProperty("studentCode","2024001");
        jsonObject.addProperty("studentName","황현덕");
        jsonObject.addProperty("studentAge","25");
        ...
        System.out.println("jsonData1에서 map으로 바꾼 사례 : " + jsonData1);
    }
}
