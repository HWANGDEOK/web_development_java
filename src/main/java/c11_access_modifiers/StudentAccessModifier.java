...
public class StudentAccessModifier {
    ...
    // 학번에 20241205, 이름에 여러분 성함, 평균에 100.0을 대입

    // showInfo() 메서드를 public으로 정의하세요
    void showInfo(){
        System.out.println(studentName+" 학생의 학번은 "+studentCode+"이며, 평균 점수는 "+studentAvg+"점 입니다.");
    }
    // 실행 예
    // OO학생의 학번은 20241205이며, 평균 점수는 100.0점입니다.
}
