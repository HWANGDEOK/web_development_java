...
//        char name2 = '근';       // 문자(charater) : 알파벳 / 한글 / 숫자 하나
//        char name3 = '수';       //
//
...
//        System.out.println("" + name1 + name2 + name3); // java의 sout의 경우 맨 앞의 자료형을 따라감
        // 즉, 큰 따옴표로 시작했을 경우 () 내에 있는 전체 자료형을 문자열로 보기 때문에 "황현덕" 전체가 출려됨

        /*
            name1, 2, 3에 여러분의 이름을 한 글자씩 재대입하고,
            sout을 통해서 콘솔창에 여러분들 이름이 출력될 수 있도록 작성하세요.
         */
        // 1. name1, 2, 3에 수강생분들 이름을 한 글자씩 재 대입하는 과정
//        name1 = '황';
//        name2 = '현';
//        name3 = '덕';
...
//        System.out.println(width1 + width2);    // 숫자끼리는 연산이 가능 - >c01에서 수업
//
//        String width3 = "300";
//        String width4 = "400";
//        System.out.println(width3 + width4);    // 문자끼리는 연산이 안되고, 나열만 가능 -> c01
//        System.out.println(width2 + width3);    // 정수 + 문자열 = 문자열로 나열 100300
//        System.out.println(width4 + width2);    // 문자열 + 정수 = 문자열로 나열 400200

        // java17 버전 이후 : 여러 줄에 걸친 데이터를 하나의 변수에 대입 가능 큰따옴표 세개를 사용합니다.
//        String introduction = """
//                안근수
//                영어교육과
//                코리아it아카데미 웹 강사
...
//        System.out.println(time);
        ...
        long(8 바이트, 64 비트)
            ...
            최소값: 9,223,372,036,854,775,807 (2^63 - 1)
         */
...
//        System.out.println(dotZero);
        ...
        // 5. 상수
        // final 자료형 변수명 = 데이터
        final String FILE_PATH = "C:/Hwang_Java";
